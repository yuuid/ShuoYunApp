...
// const DEV_HOST = 'http://192.168.43.59:3000';
const DEV_HOST = 'http://192.168.22.56:3000';
// const DEV_HOST = 'http://192.168.0.120:3000';
...
export default {
	...
	setIsLogined() {
		this.constant.isLogined = !this.constant.isLogined;
		return storageUtil.setItem(this.constant.isLogined, { isLogined: !this.constant.isLogined })
	},
	version: '1.0',//版本号
